...
# Save full matrix without truncation
np.savetxt('st_roomnet_output.txt', out, fmt='%.1f',
            header=f'OUTPUT TYPE: {type(out)}\nOUTPUT SHAPE: {out.shape}\nMODEL OUTPUT:',
            comments='')

print("Output saved to st_roomnet_output.txt")
